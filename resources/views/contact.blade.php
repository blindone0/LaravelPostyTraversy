...
@section('content')
    ...
    <div class="flex flex-col p-1 my-auto bgimg bg-cover">
        ...
        <form class="bg-white shadow-md rounded p-5 px-8 pt-6 pb-8 mb-4" action="" method="post" action="{{ route('contact.store') }}">
