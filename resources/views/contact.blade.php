...
@section('content')
    ...
    <div class="flex flex-col m-40 my-auto items-center bgimg bg-cover">
        ...
        <form class="bg-white shadow-md rounded m-20 px-8 pt-6 pb-8 mb-4" action="" method="post" action="{{ route('contact.store') }}">
            ...
            <input type="submit" name="send" value="Submit" class=" m-10 flex-shrink-0 border-transparent border-4 text-teal-500 hover:text-teal-800 text-sm py-1 px-2 rounded">
        </form>
    </div>
